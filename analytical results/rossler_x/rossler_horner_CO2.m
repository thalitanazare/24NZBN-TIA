...
mul_count_total = 0;
for i = 6:N
expr =' - 0.104*10*x(i-2) - 0.2053e-4*x(i-5)*x(i-4)^4 + 0.2484e-4*x(i-3)^2*x(i-2)^3 + 0.4353e-4*x(i-5)^4 + 0.3123e-4*x(i-4)^5 - 0.3304e-3*x(i-3)*x(i-2)^3 + x(i-1) * (0.1972*10 + 0.7456e-4*x(i-4)*x(i-2)^3 - 0.7077e-4*x(i-3)^2*x(i-2)^2 - 0.8847e-2*x(i-5) + 0.7631e-2*x(i-4) + 0.4676e-3*x(i-3)^3 + x(i-1) * (0.1238e-2*x(i-2) + 0.2258e-2*x(i-5)*x(i-2) - 0.2703e-2*x(i-3)^2 - 0.3870e-4*x(i-5)^3 + x(i-1) * (-0.7807e-3 + x(i-1) * (- 0.285e-4*x(i-5) + 0.7531e-3))))';
